...
-- --------------------------------------------------
-- Date Created: 10/16/2020 15:52:04
-- Generated from EDMX file: D:\Hao\MyProject\MyBooksCart\MyBooksCart\MyBooksCart\Models\BOOKSDB.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_Products_ToTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProductsSet] DROP CONSTRAINT [FK_Products_ToTable];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_AspNetUsersOrders]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Orders] DROP CONSTRAINT [FK_AspNetUsersOrders];
GO
...
-- Creating foreign key on [Category_Id] in table 'ProductsSet'
ALTER TABLE [dbo].[ProductsSet]
ADD CONSTRAINT [FK_Products_ToTable]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Products_ToTable'
CREATE INDEX [IX_FK_Products_ToTable]
ON [dbo].[ProductsSet]
    ([Category_Id]);
GO
...
-- Creating foreign key on [AspNetUsers_Id] in table 'Orders'
ALTER TABLE [dbo].[Orders]
ADD CONSTRAINT [FK_AspNetUsersOrders]
    FOREIGN KEY ([AspNetUsers_Id])
    REFERENCES [dbo].[AspNetUsers]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_AspNetUsersOrders'
CREATE INDEX [IX_FK_AspNetUsersOrders]
ON [dbo].[Orders]
    ([AspNetUsers_Id]);
GO
